...
- [x] Decide and document text-scope policy: formal CVE/GHSA description only, or include maintainer commit messages, or include Anthropic-authored advisory text from `red.anthropic.com`. Record decision and rationale in `docs/text-scope.md`
